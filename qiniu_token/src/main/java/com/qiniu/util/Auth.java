...
public final class Auth {
    ...
    public String sign(byte[] data) {
        Mac mac = createMac();
        String s = HexStringUtil.toHexString1(data);
//        Log.e(TAG, "liyiwei: " + s);
        byte[] doFinal = mac.doFinal(data);
        String s1 = HexStringUtil.toHexString1(doFinal);
//        Log.e(TAG, "liyiwei: " + s1);
        String encodedSign = UrlSafeBase64.encodeToString(doFinal);
//        Log.e(TAG, "liyiwei: " + encodedSign);
    ...
    public String signWithData(byte[] data) {
        ...
        Log.e(TAG, "liyiwei: " + s);
        return sign(s.getBytes()) + ":" + s;
    }

    @Deprecated // private
    public String signWithData(String data) {
        return signWithData(data.getBytes());
    }
...
//    }
    ...
    public String privateDownloadUrlWithDeadline(String baseUrl, long deadline) {
        ...
        b.append(deadline);
        String token = sign(b.toString().getBytes());
//        Log.e(TAG, "download token: " + token);
        b.append("&token=");
        b.append(token);
        return b.toString();
    }
...
//        x.put("deadline", 1686284917);

        String s = Json.encode(x);
        Log.e(TAG, "liyiwei: " + s);
        return signWithData(s.getBytes());
    }
